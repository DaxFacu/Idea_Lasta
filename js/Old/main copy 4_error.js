...
// Funciones
const DatosSelect = () =>{
    categorias= document.getElementById("categoriaSelect").value;
...
document.getElementById("go").addEventListener("click", buscarModeloCategoria());